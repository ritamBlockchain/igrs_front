...
const NAV_ITEMS: NavItem[] = [
  ...
  { name: 'Sale Mutation', icon: FileText, path: '/mutations/sale', roles: ['Admin', 'Revenue Admin', 'Collector'] },
  { name: 'Gift Mutation', icon: FileText, path: '/mutations/gift', roles: ['Admin', 'Revenue Admin', 'Collector'] },
  { name: 'Inheritance', icon: FileText, path: '/mutations/inheritance', roles: ['Admin', 'Revenue Admin', 'Revenue Officer', 'Collector'] },
  { name: 'Court Order', icon: Gavel, path: '/mutations/court-order', roles: ['Admin', 'Legal Authority', 'Court Registrar', 'Collector'] },
